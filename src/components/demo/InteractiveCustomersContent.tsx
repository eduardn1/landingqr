  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: "Clienti totali", value: totalCustomers.toString(), icon: Users, color: "from-sky-500/60 to-blue-600/60", change: "+12%" },
          { label: "Clienti attivi", value: activeCustomers.toString(), icon: Heart, color: "from-rose-500/60 to-pink-600/60", change: "+8%" },
