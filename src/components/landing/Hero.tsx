/**
 * ═══════════════════════════════════════════════════════════════════════════════
 * QRCODESTUDIOJEM - Hero Section (Monochrome + Colored Accents)
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="container relative z-10 py-24 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Trust Signals - Monochrome text, colored checkmarks */}
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-foreground-10 bg-card shadow-2xl">
              ...
              <div className="p-6 md:p-8 bg-card">
                ...
                {/* Placeholder rows - Monochrome */}
                <div className="space-y-3">
                  <div className="h-12 rounded-lg bg-foreground-05 animate-pulse" />
                  <div className="h-12 rounded-lg bg-foreground-05 animate-pulse" style={{ animationDelay: '0.1s' }} />
                  <div className="h-12 rounded-lg bg-foreground-05 animate-pulse" style={{ animationDelay: '0.2s' }} />
                </div>
              </div>
