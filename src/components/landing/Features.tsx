      ...
      <div className="container relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="sm:col-span-2 sm:row-span-2 group relative overflow-hidden rounded-2xl md:rounded-3xl bg-card border border-border p-6 md:p-10 hover:border-violet-500/30 transition-all duration-500"
          >
            ...
            <div className="relative z-10 h-full flex flex-col">
              {/* Icon */}
              <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl md:rounded-2xl bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center mb-4 md:mb-6 shadow-lg shadow-violet-500/25">
              ...
              {/* Screenshot */}
              <div className="relative flex-1 min-h-[150px] md:min-h-[200px] rounded-xl md:rounded-2xl overflow-hidden border border-border/50 mt-auto">
                <img 
                  src={qrScanPreview} 
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="group relative overflow-hidden rounded-2xl md:rounded-3xl bg-card border border-border p-5 md:p-8 hover:border-orange-500/30 transition-all duration-500"
          >
            ...
            <div className="relative z-10">
              {/* Icon */}
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg md:rounded-xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center mb-4 md:mb-5 shadow-lg shadow-orange-500/25">
              ...
              {/* Mini Screenshot */}
              <div className="relative aspect-square rounded-lg md:rounded-xl overflow-hidden border border-border/50">
                <img 
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="group relative overflow-hidden rounded-2xl md:rounded-3xl bg-card border border-border p-5 md:p-8 hover:border-emerald-500/30 transition-all duration-500"
          >
            ...
            <div className="relative z-10">
              {/* Icon */}
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg md:rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center mb-4 md:mb-5 shadow-lg shadow-emerald-500/25">
              ...
              {/* Mini Calendar Grid */}
              <div className="aspect-square rounded-lg md:rounded-xl bg-muted/30 border border-border/50 p-2 md:p-3">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="group relative overflow-hidden rounded-2xl md:rounded-3xl bg-card border border-border p-4 md:p-6 hover:border-pink-500/30 transition-all duration-500"
          >
            ...
            <div className="relative z-10">
              <div className="w-9 h-9 md:w-11 md:h-11 rounded-lg md:rounded-xl bg-gradient-to-br from-pink-500 to-rose-500 flex items-center justify-center mb-3 md:mb-4 shadow-lg shadow-pink-500/25">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="group relative overflow-hidden rounded-2xl md:rounded-3xl bg-card border border-border p-4 md:p-6 hover:border-blue-500/30 transition-all duration-500"
          >
            ...
            <div className="relative z-10">
              <div className="w-9 h-9 md:w-11 md:h-11 rounded-lg md:rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center mb-3 md:mb-4 shadow-lg shadow-blue-500/25">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="group relative overflow-hidden rounded-2xl md:rounded-3xl bg-card border border-border p-4 md:p-6 hover:border-green-500/30 transition-all duration-500"
          >
            ...
            <div className="relative z-10">
              <div className="w-9 h-9 md:w-11 md:h-11 rounded-lg md:rounded-xl bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center mb-3 md:mb-4 shadow-lg shadow-green-500/25">
