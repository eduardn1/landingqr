...
const mainFeatures = [
  {
    ...
    description: "Aggiorna piatti, prezzi e foto in tempo reale. I tuoi clienti vedono sempre l'ultima versione senza ristampare nulla.",
    image: qrScanPreview,
  ...
  },
  {
    ...
    description: "Sistema di prenotazione con conferma automatica via WhatsApp, gestione tavoli e reminder ai clienti.",
    image: null,
  ...
  },
  {
    ...
    description: "Ricevi ordini asporto e delivery con tempi stimati, conferme automatiche e zero commissioni.",
...
const secondaryFeatures = [
  {
    ...
    description: "Report vendite, piatti top e orari di punta.",
    gradient: "from-blue-500 to-cyan-500",
  },
  {
    icon: Bell,
    title: "Notifiche Real-time",
    description: "Alert istantanei per ordini e prenotazioni.",
    gradient: "from-pink-500 to-rose-500",
  },
  {
    icon: Palette,
    title: "100% Personalizzabile",
    description: "Colori, logo, template e dominio custom.",
    gradient: "from-amber-500 to-orange-500",
  },
  {
    icon: Languages,
    title: "Multi-lingua AI",
    description: "Traduzioni automatiche in 5+ lingue.",
    gradient: "from-indigo-500 to-violet-500",
  },
  {
    icon: CreditCard,
    title: "Pagamenti Integrati",
    description: "Carte, Satispay, Apple Pay e PayPal.",
